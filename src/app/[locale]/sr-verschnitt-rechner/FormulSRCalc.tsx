        ...
        <div className="flex items-start gap-3 p-3 bg-default-50 dark:bg-default-100/50 rounded-xl border border-default-200 transition-all hover:border-teal-500/50">
            ...
            <div className="flex flex-col gap-0.5">
                ...
                <Chip size="sm" variant="flat" className="h-5 text-[10px] uppercase font-bold px-1">
                    {commonT('formula.unit-label')} {unit}
                </Chip>
            </div>
        </div>
    );
                ...
                <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        ...
                        <FormulaVariable
                            ...
                            unit="g/l"
                            description={t('legend-gsr')}
                        />
                        <FormulaVariable
                            symbol={G_W}
                            colorClass="text-orange-500"
                            unit="g/l"
                            description={t('legend-gw')}
                        />
                        <FormulaVariable
                            symbol={G_Z}
                            colorClass="text-pink-600"
                            unit="g/l"
                            description={t('legend-gz')}
                        />
                    </div>
                </section>
                    ...
                    <CardBody className="p-4">
                        <div className="flex items-center justify-between gap-4 flex-wrap">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-bold text-sm">{t('total-volume')}</span>
                            </div>
