...
const FormulSo2Math: React.FC = () => {
    ...
    return (
        <Card className="w-full border-none shadow-2xl mt-8 overflow-hidden" radius="2xl">
            <CardHeader className="flex gap-4 bg-wine-600 p-6 text-white">
                ...
                <div className="flex flex-col">
                    ...
                    <p className="text-[10px] opacity-80 uppercase font-black tracking-[0.2em]">Oenological Standards</p>
                </div>
            </CardHeader>
                ...
                <div className="p-6 sm:p-10 space-y-16">
                    ...
                    <section className="relative">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <Chip size="sm" variant="dot" color="primary" className="font-bold border-none">Mass Calculation</Chip>
                        </div>
                    ...
                    <section className="relative">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <Chip size="sm" variant="dot" color="secondary" className="font-bold border-none">Volume Calculation</Chip>
                        </div>
            ...
            <div className="bg-default-50 border-t border-divider p-4 flex justify-center items-center gap-4 text-default-400 text-[10px] font-black uppercase tracking-widest">
                <span>International Oenology Unit</span>
                <MoveRight size={12} />
                <span>SI Standard</span>
            </div>
        </Card>
    );
};
